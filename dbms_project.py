...
def Bill_generate():
	...
	qq.pack()
	my_db = mysql.connector.connect(host="localhost", user="rajarshi", passwd="root", database="rajarshi", autocommit=True,buffered=True)
	cur = my_db.cursor()
	cur1 = my_db.cursor()
...
def restock_pharmacy():
	...
	bbt1.grid(row=len(lis)+5,column=0)
	v2.mainloop()
